...
!
interface Loopback1
 ip address 10.20.15.22 255.255.255.255
 ip ospf 1 area 20
!
interface Tunnel0
...
interface Ethernet0/0
 ip address 11.22.10.2 255.255.255.252
 ip nat outside
...
router bgp 2002
 ...
 neighbor 10.20.15.21 remote-as 2002
 neighbor 10.20.15.21 update-source Loopback1
 neighbor 11.22.10.1 remote-as 202
 neighbor 11.22.10.1 route-map BLOCK-OUT out
!
