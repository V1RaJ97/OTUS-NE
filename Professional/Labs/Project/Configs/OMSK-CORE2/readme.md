...
!
interface Loopback1
 ip address 10.30.15.22 255.255.255.255
 ip ospf 1 area 30
!
interface Tunnel0
...
interface Ethernet0/0
 ip address 11.32.10.2 255.255.255.252
 ip nat outside
...
interface Ethernet0/2
 ip address 10.30.22.1 255.255.255.252
 ip nat inside
 ip virtual-reassembly in
 ip ospf network point-to-point
 ip ospf 1 area 30
...
router bgp 3003
 ...
 neighbor 10.30.15.21 remote-as 3003
 neighbor 10.30.15.21 update-source Loopback1
 neighbor 11.32.10.1 remote-as 302
 neighbor 11.32.10.1 route-map BLOCK-OUT out
!
