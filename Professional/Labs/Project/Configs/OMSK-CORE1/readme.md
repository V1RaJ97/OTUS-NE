...
!
interface Loopback1
 ip address 10.30.15.21 255.255.255.255
 ip ospf 1 area 30
!
interface Tunnel0
...
interface Ethernet0/0
 ip address 11.31.10.2 255.255.255.252
 ip nat outside
 ip virtual-reassembly in
!
interface Ethernet0/1
 ip address 10.30.11.1 255.255.255.252
 ip nat inside
 ip virtual-reassembly in
...
router bgp 3003
 ...
 neighbor 10.30.15.22 remote-as 3003
 neighbor 10.30.15.22 update-source Loopback1
 neighbor 11.31.10.1 remote-as 301
 neighbor 11.31.10.1 route-map BLOCK-OUT out
!
