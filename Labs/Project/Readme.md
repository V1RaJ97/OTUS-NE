...
|:----------:|:----------------:|:--------------:|:-------------:|:-----------------:|
|     R1     |     Loopback1    |   172.16.1.1   | _____________ |                   |
...
|     R2     |     Loopback1    |   172.16.1.2   | _____________ |                   |
...
|     S5     |      VLAN 11     |   10.11.0.5    | 255.255.255.0 |     10.11.0.1     |
...
S3(config)#spanning-tree vlan 10,20,30,40,50,60,70,100,1000 root secondary 
